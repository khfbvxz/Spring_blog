...
import com.cos.authjwt.security.user.OAuth2UserInfo;
import com.cos.authjwt.security.user.OAuth2UserInfoFactory;
...
//        System.out.println("loadUser "+oAuth2User.getName());
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        User user;
        System.out.println("processOAuth2User "+userOptional);
